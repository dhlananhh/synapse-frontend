...
export const authService = {
  register: (
    ...
    return authApiClient
      .post(`${AUTH_SERVICE_URL}/register`, apiPayload)
      .then((res) => res.data);
  },
  ...
  login: (
    ...
    return authApiClient
      .post(`${AUTH_SERVICE_URL}/login`, payload)
      .then((res) => res.data);
  },

  getMe: (): Promise<AuthUser> => {
    return authApiClient
      .get(`${AUTH_SERVICE_URL}/me`)
      .then((res) => res.data);
  },
  ...
  verifyEmail: (
    ...
    return authApiClient
      .post(`${AUTH_SERVICE_URL}/verify-email`, payload)
      .then((res) => res.data);
  },
  ...
  resendVerification: (
    ...
    return authApiClient
      .post(
        `${AUTH_SERVICE_URL}/resend-verification`,
        payload
      )
      .then((res) => res.data);
  },
  ...
  requestPasswordReset: (
    ...
    return authApiClient
      .post(
        `${AUTH_SERVICE_URL}/request-password-reset`,
        payload
      )
      .then((res) => res.data);
  },
  ...
  verifyPasswordResetCode: async (
    ...
    const response = await authApiClient.post(
      `${AUTH_SERVICE_URL}/verify-reset-code`,
      payload
    );
  ...
  setNewPassword: (
    ...
    if (!resetToken) {
      return Promise.reject(
        new Error("Reset token not found or expired.")
      );
    }
