...
import { ResetPasswordSchema, TResetPasswordSchema } from '@/libs/validators/auth-validator'
    ...
    return (
      <Card className='mx-auto max-w-lg w-full'>
        <CardHeader className='text-center'>
          ...
          <CardDescription>Invalid reset password link. Email is missing.</CardDescription>
        </CardHeader>
        <CardContent>
