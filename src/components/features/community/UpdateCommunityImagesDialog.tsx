...
export function UpdateCommunityImagesDialog({
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      if (avatarFile) {
        const response =
          await communityService.updateAvatar(
            community.id,
            avatarFile
          );
      ...
      if (bannerFile) {
        const response =
          await communityService.updateBanner(
            community.id,
            bannerFile
          );
        latestCommunityData = response.data;
      ...
      <DialogContent className="sm:max-w-xl">
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-2">
            ...
            <div
              className="bg-secondary relative flex aspect-[3/1] w-full cursor-pointer items-center justify-center rounded-lg border-2 border-dashed"
              onClick={() =>
            ...
            >
              ...
              <p className="absolute right-2 bottom-2 rounded bg-black/50 px-2 py-1 text-xs text-white">
