  ...
  return (
    <Card>
      <CardHeader className="pt-2">
        ...
        <CardDescription>
          This is the first step to building your own
          community on Synapse.
        </CardDescription>
      </CardHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Community name can only contain letters,
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      If turned on, only members you approve
                      can view and post.
                    </FormDescription>
                  </div>
                  <FormControl>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Is your community 18+ (Not Safe For
                      Work)?
                    </FormDescription>
                  </div>
                  <FormControl>
