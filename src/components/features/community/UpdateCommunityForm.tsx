          ...
          render={
            ({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Community name must be 3-50 characters long and can only contain letters, numbers, underscores, and hyphens.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )
          ...
          render={
            ({ field }) => (
              <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4"><div className="space-y-0.5">
                ...
                <FormDescription>
                  Check this box if your community contains content intended for members aged 18 and older.
                </FormDescription>
              </div>
                <FormControl>
                  <Switch
