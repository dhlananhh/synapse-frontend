...
interface UpdateCommunityFormProps {
  ...
  onSubmit: (data: TUpdateCommunityDetailsSchema) => Promise<void>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Community name must be 3-50 characters long and can only contain letters, numbers,
          ...
          render={({ field }) => (
            <FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
              <div className='space-y-0.5'>
                ...
                <FormDescription>Only approved members can view and post.</FormDescription>
              </div>
              <FormControl>
          ...
          render={({ field }) => (
            <FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
              <div className='space-y-0.5'>
                ...
                <FormDescription>
                  Check this box if your community contains content intended for members aged 18 and
                  older.
                </FormDescription>
              </div>
              <FormControl>
          ...
          render={({ field }) => (
            <FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
              <div className='space-y-0.5'>
                ...
                <FormDescription>All posts require moderator approval.</FormDescription>
              </div>
              <FormControl>
                <Switch checked={field.value} onCheckedChange={field.onChange} />
              </FormControl>
