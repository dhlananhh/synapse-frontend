...
import { ArrowLeft, Lock, Loader2, ImageIcon } from 'lucide-react'
    ...
    return (
      <div className='text-center py-20'>
        ...
        <p className='mt-2 text-muted-foreground'>
          Only the owner of <span className='font-semibold'>c/{community.name}</span> can edit these
          settings.
        </p>
  ...
  return (
    <>
      <div className='max-w-3xl mx-auto space-y-8'>
        <Button
          variant='ghost'
          onClick={() => router.push(`/c/${community.name}/manage`)}
          className='mb-4 -ml-4'
        >
          <ArrowLeft className='mr-2 h-4 w-4' />
        ...
        <Card>
          <CardHeader>
            <CardTitle className='text-2xl'>Edit Community Details</CardTitle>
            <CardDescription>
              Update your community's name, description, and privacy settings. Changes will be
              visible to everyone.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Community Visuals</CardTitle>
            <CardDescription>Customize a new aesthetic look of your community.</CardDescription>
          </CardHeader>
        ...
        <Card className='border-destructive/50 bg-destructive/5'>
          ...
          <CardContent className='flex justify-between items-center'>
            <div>
              <h4 className='font-semibold'>Delete This Community</h4>
