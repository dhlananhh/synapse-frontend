...
//   const staticRoutes = ['/', '/feed', '/login', '/register', '/submit'].map((route) => ({
//     url: `${siteUrl}${route}`,
...
//   const allUsers = [
//     ...new Map(mockPosts.map((post) => [post.author.username, post.author])).values(),
//   ]
...
//   return [...staticRoutes, ...communityRoutes, ...postRoutes, ...userRoutes]
// }
